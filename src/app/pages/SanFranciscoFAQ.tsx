...
const faqs: FAQItem[] = [
  {
    ...
    answer: "The median home price in San Francisco is approximately $1.35 million as of 2024. However, prices vary dramatically by neighborhood—from around $800,000 for condos in outer neighborhoods to $5 million or more for single-family homes in Pacific Heights, Noe Valley, or Sea Cliff. The market has seen fluctuations with tech industry cycles, but long-term appreciation remains strong due to limited land and strict zoning."
  },
  {
    question: "Is San Francisco a good place to buy a home in 2025?",
    answer: "San Francisco offers unique value for buyers in 2025. While prices have moderated from 2022 peaks, the city's limited housing supply, world-class amenities, and recovering tech sector support long-term appreciation. Key factors to consider include your timeline (5+ year holds typically perform well), neighborhood selection (some areas are appreciating faster than others), and the type of property (single-family homes have outperformed condos recently)."
  },
  {
    question: "What are the best neighborhoods in San Francisco for families?",
    answer: "Top family-friendly neighborhoods include Noe Valley (excellent schools, stroller-friendly streets), Glen Park (quieter village feel, BART access), West Portal (tight-knit community, good public schools), and Forest Hill (larger homes, safe streets). The Sunset and Richmond districts offer more affordable single-family homes with good schools, though they experience more fog. Each neighborhood has distinct character, so visiting multiple times before buying is essential."
  },
  {
...
export function SanFranciscoFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="San Francisco Real Estate FAQ | Home Buying Guide 2025"
        description="Expert answers to common San Francisco home buying questions. Learn about prices, neighborhoods, property taxes, first-time buyer programs, and more from a Bay Area realtor with 15+ years experience."
        canonical="https://cascaderealtors.com/sfo"
        city="San Francisco"
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
            San Francisco Real Estate FAQ
          </h1>
          <p className="text-xl text-gray-600 font-light leading-relaxed max-w-2xl">
            Everything you need to know about buying a home in San Francisco. Expert answers from a Bay Area real estate professional with 15+ years of experience.
          </p>
        </div>
      </section>
