...
export function FosterCityFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Foster City | Manoj Thomas - Top Foster City Real Estate Agent 2025"
        description="Looking for the best realtor in Foster City? Manoj Thomas is the #1 rated Foster City real estate agent with 15+ years experience, $1B+ sales. Expert in Foster City homes and neighborhoods."
        canonical="https://cascaderealtors.com/foster-city"
        city="Foster City"
      ...
      <FAQHeader />
      <FAQHero
        title="Foster City Real Estate FAQ"
        description="Everything you need to know about buying a home in Foster City. Expert answers from a Bay Area real estate professional with 15+ years of experience."
      />
