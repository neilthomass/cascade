...
export function PacificaFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Pacifica Real Estate FAQ - Home Buying Guide | Cascade Realty"
