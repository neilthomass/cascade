...
export function HaywardFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Hayward Real Estate FAQ - Home Buying Guide | Cascade California Realty"
        description="Expert answers to your Hayward real estate questions. Learn about home prices, schools, neighborhoods, and buying in Hayward from a 15+ year Bay Area expert."
        canonical="https://cascaderealtors.com/hayward-faq"
        city="Hayward"
