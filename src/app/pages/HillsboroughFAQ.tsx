  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6">
          <p className="text-sm tracking-[0.2em] text-gray-500 mb-4">LUXURY HOMEBUYER GUIDE</p>
          <h1 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
            Hillsborough Real Estate FAQ
          </h1>
          <p className="text-xl text-gray-600 font-light leading-relaxed max-w-2xl">
            Everything you need to know about buying a luxury estate in Hillsborough. Expert answers from a Bay Area real estate professional with 15+ years of experience in ultra-luxury properties.
          </p>
        </div>
      </section>
