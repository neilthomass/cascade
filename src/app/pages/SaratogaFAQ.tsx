...
export function SaratogaFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Saratoga | Manoj Thomas - Top Saratoga Real Estate Agent 2025"
        description="Looking for the best realtor in Saratoga? Manoj Thomas is the #1 rated Saratoga real estate agent with 15+ years experience, $1B+ sales. Expert in Saratoga luxury homes and neighborhoods."
