...
export function LosGatosFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Los Gatos | Manoj Thomas - Top Los Gatos Real Estate Agent 2025"
        description="Looking for the best realtor in Los Gatos? Manoj Thomas is the #1 rated Los Gatos real estate agent with 15+ years experience, $1B+ sales. Expert in Los Gatos luxury homes."
