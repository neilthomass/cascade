...
export function LosAltosFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Los Altos Real Estate FAQ | Home Buying Guide 2025"
        description="Expert answers to common Los Altos home buying questions. Learn about prices, neighborhoods, and more from a Bay Area realtor with 15+ years experience."
