...
export function LosAltosFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Los Altos | Manoj Thomas - Top Los Altos Real Estate Agent 2025"
        description="Looking for the best realtor in Los Altos? Manoj Thomas is the #1 rated Los Altos real estate agent with 15+ years experience, $1B+ sales. Expert in Los Altos luxury homes."
        canonical="https://cascaderealtors.com/los-altos"
        city="Los Altos"
      ...
      <FAQHeader />
      <FAQHero
        title="Los Altos Real Estate FAQ"
        description="Everything you need to know about buying a home in Los Altos. Expert answers from a Bay Area real estate professional with 15+ years of experience."
      />
