...
export function DublinFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Dublin | Manoj Thomas - Top Dublin CA Real Estate Agent 2025"
        description="Looking for the best realtor in Dublin, CA? Manoj Thomas is the #1 rated Dublin real estate agent with 15+ years experience, $1B+ sales. Expert in Dublin and Tri-Valley homes."
        canonical="https://cascaderealtors.com/dublin"
        city="Dublin"
