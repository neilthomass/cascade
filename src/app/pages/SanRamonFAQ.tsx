...
export function SanRamonFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in San Ramon | Manoj Thomas - Top San Ramon Real Estate Agent 2025"
        description="Looking for the best realtor in San Ramon? Manoj Thomas is the #1 rated San Ramon real estate agent with 15+ years experience, $1B+ sales. Expert in San Ramon and Tri-Valley homes."
        canonical="https://cascaderealtors.com/san-ramon"
        city="San Ramon"
