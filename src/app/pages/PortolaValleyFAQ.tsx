...
export function PortolaValleyFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Portola Valley | Manoj Thomas - Top Portola Valley Real Estate Agent 2025"
        description="Looking for the best realtor in Portola Valley? Manoj Thomas is the #1 rated Portola Valley real estate agent with 15+ years experience, $1B+ sales. Expert in Portola Valley homes and neighborhoods."
        canonical="https://cascaderealtors.com/portola-valley"
        city="Portola Valley"
