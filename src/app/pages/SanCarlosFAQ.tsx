...
export function SanCarlosFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in San Carlos | Manoj Thomas - Top San Carlos Real Estate Agent 2025"
        description="Looking for the best realtor in San Carlos? Manoj Thomas is the #1 rated San Carlos real estate agent with 15+ years experience, $1B+ sales. Expert in San Carlos homes and neighborhoods."
        canonical="https://cascaderealtors.com/san-carlos"
        city="San Carlos"
      ...
      <FAQHeader />
      <FAQHero
        title="San Carlos Real Estate FAQ"
