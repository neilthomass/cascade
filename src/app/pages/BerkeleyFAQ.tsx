...
export function BerkeleyFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Berkeley | Manoj Thomas - Top Berkeley Real Estate Agent 2025"
        description="Looking for the best realtor in Berkeley? Manoj Thomas is the #1 rated Berkeley real estate agent with 15+ years experience, $1B+ sales. Expert in Berkeley homes and neighborhoods."
        canonical="https://cascaderealtors.com/berkeley"
        city="Berkeley"
