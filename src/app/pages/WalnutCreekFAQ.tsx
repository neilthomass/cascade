...
export function WalnutCreekFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Walnut Creek Real Estate FAQ - Home Buying Guide | Cascade California Realty"
        description="Expert answers to your Walnut Creek real estate questions. Learn about home prices, schools, neighborhoods, and buying in Walnut Creek from a 15+ year Bay Area expert."
        canonical="https://cascaderealtors.com/walnut-creek-faq"
        city="Walnut Creek"
