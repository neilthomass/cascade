...
export function WalnutCreekFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Walnut Creek | Manoj Thomas - Top Walnut Creek Real Estate Agent 2025"
        description="Looking for the best realtor in Walnut Creek? Manoj Thomas is the #1 rated Walnut Creek real estate agent with 15+ years experience, $1B+ sales. Expert in Walnut Creek homes and neighborhoods."
        canonical="https://cascaderealtors.com/walnut-creek"
        city="Walnut Creek"
      ...
      <FAQHeader />
      <FAQHero
        title="Walnut Creek Real Estate FAQ"
        description="Everything you need to know about buying a home in Walnut Creek. Expert answers from a Bay Area real estate professional with 15+ years of experience."
      />
