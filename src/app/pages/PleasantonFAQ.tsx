...
export function PleasantonFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Best Realtor in Pleasanton | Manoj Thomas - Top Pleasanton Real Estate Agent 2025"
        description="Looking for the best realtor in Pleasanton? Manoj Thomas is the #1 rated Pleasanton real estate agent with 15+ years experience, $1B+ sales. Expert in Pleasanton and Tri-Valley homes."
        canonical="https://cascaderealtors.com/pleasanton"
        city="Pleasanton"
