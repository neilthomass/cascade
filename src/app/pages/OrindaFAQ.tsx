...
export function OrindaFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <FAQHeader />
      <FAQHero
        title="Orinda Real Estate FAQ"
        description="Everything you need to know about buying a home in Orinda. Expert answers from a Bay Area real estate professional with 15+ years of experience."
      />
