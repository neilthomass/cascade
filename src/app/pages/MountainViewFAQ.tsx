...
export function MountainViewFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <FAQHeader />
      <FAQHero
        title="Mountain View Real Estate FAQ"
        description="Everything you need to know about buying a home in Mountain View. Expert answers from a Bay Area real estate professional with 15+ years of experience."
      />
