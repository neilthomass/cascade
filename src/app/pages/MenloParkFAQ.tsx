...
const faqs: FAQItem[] = [
  {
    ...
    answer: "The median home price in Menlo Park is approximately $3.2 million as of 2025. However, prices vary significantly by neighborhood—from around $2 million for smaller homes in Belle Haven to $5-10 million or more for luxury estates in west Menlo Park neighborhoods like Sharon Heights and the Willows. The city's proximity to Stanford University and Meta headquarters has made it one of the most expensive markets in the Bay Area."
  },
  {
...
export function MenloParkFAQ() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        title="Menlo Park Real Estate FAQ - Home Buying Guide | Cascade Realty"
      ...
      <section className="bg-gray-50 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-light text-gray-900 mb-6 leading-tight">
            Menlo Park Real Estate FAQ
          </h1>
          <p className="text-xl text-gray-600 font-light leading-relaxed max-w-2xl">
            Everything you need to know about buying a home in Menlo Park. Expert answers from a Bay Area real estate professional with 15+ years of experience.
          </p>
        </div>
      </section>
